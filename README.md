...
Running the same structured prompt N times (typically 3–5)
Collecting the resulting estimates
Aggregating via median (for calorie numbers) or majority vote (for food identification)
